...
<?php
    ...
    <tr>
      <td style="background-color:none;" colspan=10 align=left><a href="index.php" style="margin-top:5px;"><button type="button" class="btn btn-primary">Enter new user</button></a></td>
    </tr>
        ...
        <tr style="background-color:none;">
            ...
            <td class="text" style="width:10%;" align="center"><a href="update.php?uid=<?php echo $data['id']?>"><button type="button" class="btn btn-primary">Update</button></a></td>
            <td class="text" style="width:10%;" align="center">
                <button type="submit" class="btn btn-danger" onclick="deletedata(<?php echo $data['id']?>);">Delete</button>
            </td>
                ...
                $.ajax({
                    ...
                    success function(response) {
                        if (response == 1) {
                            ...
                            alert("User not deleted, problame occure..");
                        }
                    }
                });
            });
